...
Note: defining 1 year = 365.0 days = 3.1536e7 s for 'kg*year' exposure.
"""
...
_Q0_FDM_QBOHR = 1. # sets the ratio q0_fdm/qBohr.
q0_fdm = _Q0_FDM_QBOHR*qBohr # the reference momentum for F_DM form factor
SECONDS_PER_YEAR = 3.1536e7 # for future reference in rate normalization
